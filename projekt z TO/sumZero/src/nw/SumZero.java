...
public class SumZero {
    ...
    public static void main(String args[]) {
        ...
        sumZero(list);
        /* TEST1
            przy takiej tablicy daje tylko -4 -2 6, a powienien rowniez -2,-1,3
         */

        int[] a = new int[]{-2, -1, 2, 3, -4, 4, 6};
        Arrays.sort(a);
        sum3Zero(a);
        sum3Zero1(a);

        /* TEST2
            pusta tablica, test przechodzi - wypisuje "too short of list"
         */
        ...
        /* TEST3
            gdy nie znajdzie sumy, test przechodzi
         */
