...
public class longPalindromicString {
    public static void main(String[] args) {
        final String s = "abcaabcabcaacb";

        /* TESTY
        dla s="" output:
        dla s="aaaaaaaaaaa" output: aaaaaaaaaaa
        dla s="aavvvbbbbbbbb" output: bbbbbbbb
        dla s="abcaabcabcaacb" output: bcaacb
        dla s="abbbacddcffgcddca" output: abbba
         */
