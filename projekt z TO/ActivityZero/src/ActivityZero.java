...
public class ActivityZero {
    ...
    public static void main(String args[]) {
        ...
        /*TESTY:
        1) nie sprawdza inputu w zaden sposob; puszcza wszystko a potem sie wykrzacza
        1') można wprowadzać String,String - błąd
        2) showSum od pustego - dziala
        showSum(new ArrayList<ActivityZero>());
        3)
         */
